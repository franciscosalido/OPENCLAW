...
from integration.safety_scan import assert_no_forbidden_fields, find_forbidden_fields, is_safe_trace_id, json_has_no_forbidden_fields
...
def test_report_scanner_catches_raw_content_keys() -> None:
    assert find_forbidden_fields({"raw_prompt": "x", "safe": {"document_text": "y"}}) == ["document_text", "raw_prompt"]
